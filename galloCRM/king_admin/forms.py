...
def create_model_form(request,admin_class):
    ...
    #             set_m2m_vals_from_frontend = set(self.cleaned_date.get(field))
    ...
    #
    #     admin_class.default_form_validation
    ...
    #对name进行验证
    def clean_name(self):
        print("name clean validation:",self.cleaned_date["name"])
        if not self.cleaned_date["name"]:
