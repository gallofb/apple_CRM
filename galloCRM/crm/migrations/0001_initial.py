# Generated by Django 2.1.7 on 2019-03-21 01:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('class_type', models.SmallIntegerField(choices=[(0, '面授(周中)'), (1, '面授(周末)'), (2, '网络')], verbose_name='课程类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.SmallIntegerField(choices=[(0, '转介绍'), (1, 'qq群'), (2, '官网'), (3, '百度'), (4, '市场推销'), (5, '知乎')])),
                ('referral_from', models.CharField(blank=True, max_length=64, null=True, verbose_name='转介绍人qq')),
                ('content', models.TextField(verbose_name='咨询详情')),
                ('status', models.SmallIntegerField(choices=[(0, '转介绍'), (1, 'qq群'), (2, '官网'), (3, '百度'), (4, '市场推销'), (5, '知乎')], default=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intention', models.SmallIntegerField(choices=[(0, '2周内报名'), (1, '一月内报名'), (2, '近期无报名计划'), (3, '已在其他机构报名'), (4, '已报名'), (5, '已拉黑')])),
                ('date', models.DateTimeField(auto_now_add=True)),
            ],
            options={
